...
constexpr gpio_num_t PIN_SCL = GPIO_NUM_8;
constexpr gpio_num_t PIN_SDA = GPIO_NUM_9;
constexpr i2c_port_num_t I2C_PORT = I2C_NUM_0;

constexpr uint32_t I2C_TIMEOUT_MS = 100;

extern i2c_master_bus_handle_t bus;
extern i2c_master_dev_handle_t devRtc;
extern i2c_master_dev_handle_t devOled;
