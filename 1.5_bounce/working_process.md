...
[KiCad schematic](https://github.com/Lians-coder/embedded_HW/blob/main/1.5_bounce/bounce.kicad_sch) schematic.  
...
TAfter introducing debounce logic in the firmware, the serial monitor output became stable and matched the expected number of button presses, while the physical bounce behavior observed on the logic analyzer remained unchanged. This confirms that the debounce implementation effectively filtered out transitions caused by mechanical bouncing.  
